...
public class Login implements Accion {
	...
	public String ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		if (usuario != null) {
			...
			HttpSession sesion = request.getSession(); //Mantiene los datos de la request para recordar el ID de la sesion iniciada
			sesion.setAttribute("loginUsuario", usuario); //Cada vez que se intenta enviar la sesion, se guarda el objeto que lo persmite
